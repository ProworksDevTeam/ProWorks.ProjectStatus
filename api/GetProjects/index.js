...
function validateRequest(context, req, projects, preferences) {
    ...
    if (typeof result !== 'object' || typeof result.userPreferences !== 'object') {
        context.log('Invalid request - ' + JSON.stringify(req));
        context.res = { status: 500 };

        if (typeof result === 'string') context.res.body = result;
        else if (typeof result.userPreferences !== 'object') context.res.body = "Missing preference information";
